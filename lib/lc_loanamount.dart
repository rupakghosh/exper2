...
class calciii extends StatefulWidget {
  @override
...
///Crafting the UI
class calciiistate extends State<calciii> {
            ...
            Padding(
              ...
              child: Row(
                children: <Widget>[
                  ...
                  getCalcButton('Loan Amount', Colors.orangeAccent, calculate),
                  Container(
                    width: 10.0,
                  ),
  ...
  String calculate() {
    var emi = double.parse(principalController.text);
